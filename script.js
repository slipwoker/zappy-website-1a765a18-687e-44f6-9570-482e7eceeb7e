        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '1a765a18-687e-44f6-9570-482e7eceeb7e',
                name: formData.name,
                email: formData.email,
                subject: formData.interest || 'Contact Form Submission',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מועדון הכושר של החיים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
